  ...
  <ion-menu content-id="main-content" type="overlay">
    <ion-content>
      ...
      <ion-list id="labels-list">
        ...
        <ion-note></ion-note>
        <ion-list-header>
          <p style="color: rgb(97, 97, 252)">I</p>
          <p style="color: rgb(253, 172, 51)">t</p>
          <p style="color: rgb(3, 167, 39)">s</p>
          <p style="color: rgb(93, 93, 97)">.</p>
          <p style="color: rgb(3, 3, 219)">Redu</p>
        </ion-list-header>
      </ion-list>
    </ion-content>
  </ion-menu>
...
ion-menu.ios ion-item.selected ion-label {
  color: var(--ion-color-primary); /* Altera a cor do texto para azul */
}
...
ion-menu ion-list#interacao-list ion-item.selected {
  --background: rgba(var(--ion-color-primary-rgb), 0.14); /* Altera a cor de fundo para azul quando selecionado */
}
